...
<body>
	<div class="page-container">
		<form action="${pageContext.request.contextPath}/travel/addHotel" method="post" class="form form-horizontal"
			id="form-article-add">
			<div class="row cl">
				...
				<div class="formControls col-xs-6 col-sm-7">
					<input type="text" class="input-text" value=""
						placeholder="请设置图片链接" id="hotelpic" name="hotelpic">
				</div>
				...
				<div class="formControls col-xs-6 col-sm-7">
					<input type="text" class="input-text" value=""
						placeholder="请设置酒店名称" id="hotelname" name="hotelname">
				</div>
				<div class="formControls col-xs-2 cols-sm-2" id="tip"></div>
				</div>
					<div class="row cl">
				...
				<div class="formControls col-xs-6 col-sm-7">
					<input type="text" class="input-text" value=""
						placeholder="请设置酒店价格" id="hotelprice" name="hotelprice">
				</div>
				<div class="formControls col-xs-2 cols-sm-2" id="tip"></div>
				</div>

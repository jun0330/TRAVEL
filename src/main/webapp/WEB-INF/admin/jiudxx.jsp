    ...
    <div class="row jdjs-main">
      <div class="col-md-10">
        <div class="row parameter">
          <div class="col-md-6"><img src="${pageContext.request.contextPath}/img/jdjsxx.png" id="img" class="img-responsive"></div>
          <div class="col-md-6">
            ...
            <em>酒店等级：<span class="s_star_1"><i class="s_d8"></i></span></em> <em>地址：厦门市思明区软件园二期望海路71号楼<span style="margin-left:10px"><a href="?#hotel">
                                  查看地图</a></span></em><em>房间数量：99+</em> <em>电话号码：+110 1101000</em> <em>营业时间：全天24小时  00：00-24：00</em> <em>服务宗旨：你的微笑是我们最大的成功</em> <em><span style="color:#FFA500;font-size:24px;">99.9%</span>好评率</em><a href="?#disport"><em>查看<span style="color:#FFA500">1030</span>条评论</em></a></div>
        ...
        <div id="about">
         <div class="row parameter">
          <div class="col-md-2"><img src="img/jdjsxx.png" style="width:150;height:110px;" class="img-responsive"></div>
           <div class="col-md-10">
           <div class="row">
            <span class="col-md-4" style="font-size:30px;margin-right:65px;">特价房</span><span class="col-md-6" style="color:#FF4500;font-size:24px;margin-right:20px;"><span  style="color:#FF4500;font-size:15px;">￥</span>840<span  style="color:#000000;font-size:14px">起</span></span>
             </div>
          ...
          <em>床型<span style="margin-left:20px;">大床1.5x2.0米1张</span></em>
           ...
           <div class="row parameter">
            <div class="col-md-2"><img src="img/jdjsxx.png" style="width:150;height:110px;" class="img-responsive"></div>
             <div class="col-md-10">
              <div class="row">
               <span class="col-md-4" style="font-size:30px;margin-right:65px;">标准双床房</span><span class="col-md-6" style="color:#FF4500;font-size:24px;margin-right:20px;"><span  style="color:#FF4500;font-size:15px;">￥</span>840<span  style="color:#000000;font-size:14px">起</span></span>
                </div>
                 <span style="margin-right:10px;color:#FF4500;">上网</span><span style="margin-right:15px;">宽带</span><span style="margin-right:10px;">|</span>
                   <span style="margin-right:10px;color:#FF4500;">卫浴</span><span style="margin-right:15px;">独立</span><span style="margin-right:10px;">|</span>
                          <span style="margin-right:10px;color:#FF4500;">窗户</span><span style="margin-right:15px;">无</span><span style="margin-right:10px;">|</span> <span style="margin-right:10px;color:#FF4500;">可住</span><span>2人</span>
          ...
          <div class="col-md-2"><img src="img/jdjsxx.png" style="width:150;height:110px;" class="img-responsive"></div>
           <div class="col-md-10">
            <div class="row">
           <span class="col-md-4" style="font-size:30px;margin-right:65px;">豪华双人间</span><span class="col-md-6" style="color:#FF4500;font-size:24px;margin-right:20px;"><span  style="color:#FF4500;font-size:15px;">￥</span>840<span  style="color:#000000;font-size:14px">起</span></span>
            </div>
            <span style="margin-right:10px;color:#FF4500;">上网</span><span style="margin-right:15px;">宽带</span><span style="margin-right:10px;">|</span>
                   <span style="margin-right:10px;color:#FF4500;">卫浴</span><span style="margin-right:15px;">独立</span><span style="margin-right:10px;">|</span>

      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
        	<li><a href="${pageContext.request.contextPath}/Scenic.jsp" target="_blank">景点</a></li>
					...
					<li><a href="${pageContext.request.contextPath}/about.jsp" target="_blank">关于我们</a></li>i>
        </ul>
      </div>
    </div>
  </nav>
...
<script type="text/javascript">
    ...
    function createIcon(json){
        var icon = new BMap.Icon("${pageContext.request.contextPath}/img/jdjsxx.png", new BMap.Size(json.w,json.h),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})
        return icon;
    }

...
<body>
	<div class="page-container">
		<form action="${pageContext.request.contextPath}/travel/addView" method="post" class="form form-horizontal"
			id="form-article-add">
			<!-- 首页图片1 -->
			<div class="row cl">
				...
				<div class="formControls col-xs-6 col-sm-7">
					<input type="text" class="input-text" value=""
						placeholder="请设置首页图片" id="scenicpic" name="scenicpic">
				</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-6 col-sm-7">
					<input type="text" class="input-text" value=""
						placeholder="请设置景点名称" id="scenicname" name="scenicname">
				</div>

...
<body>
			...
			<div class="head-top">
				...
				<div class="logo-right col-md-6 col-sm-8 col-xs-12">
					<div class="search col-md-12 col-sm-12">
						<i class="taobao"></i> <i class="sina"></i> <i class="wx"></i>
	...
	<form action="myupload" method="post" enctype="multipart/form-data">
		<div class="container">
			<div class="col-md-12">
				<div class="col-md-12"
					style="background: url(img/pic04.jpg) no-repeat; background-size: cover;"
					id="div03"></div>
				<!-- <span style="color:black;margin-top:12px;font-size:27px;background:white;height:100px;">标题：</span> -->
				<label
					style="color: gray; margin-right: 700px; font-size: 23px; margin-top: 16px;">游记标题：</label>
				<input class="col-md-12" type="text" style="height: 50px;">
			</div>
			<div class="col-md-12">
				<label
					style="color: gray; margin-right: 700px; font-size: 23px; margin-top: 16px;">前言(选填)：</label>
				<textarea class="col-md-12" style="resize: none; height: 120px;"></textarea>

				<label
					style="color: gray; margin-right: 700px; font-size: 23px; margin-top: 16px;">正文：</label>

				<textarea class="col-md-8" style="resize: none; height: 550px;"></textarea>
				<div class="col-md-3" id="div"
					style="background: url(img/pic02.jpg) no-repeat; background-size: cover;">

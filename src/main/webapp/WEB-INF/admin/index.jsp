...
<aside class="Hui-aside">
	...
	<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/travel/showScenic" data-title="首页景点列表" href="javascript:void(0)">首页景点列表</a></li>
			</ul>
		</dd>
	</dl>
	
	<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe622;</i>用户目录<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/travel/showUsers" data-title="用户目录" href="javascript:void(0)">用户列表</a></li>
			</ul>
		</dd>
	</dl>
	...
	<dl id="Express">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/travel/showView" data-title="景点管理" href="javascript:void(0)">景点列表</a></li>
			</ul>
		</dd>
	</dl>
	
	<dl id="menu-member">
			<dt><i class="Hui-iconfont">&#xe60d;</i> 酒店详细<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/travel/showHotelInfo" data-title="酒店详细列表" href="javascript:void(0)">酒店详细列表</a></li>
			</ul>
		</dd>
	</dl>
	...
	<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/travel/showHotel" data-title="酒店列表" href="javascript:void(0)">酒店列表</a></li>
			</ul>
		</dd>
	</dl>
	...
	<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/travel/showComment" data-title="评论管理列表" href="javascript:void(0)">评论管理列表</a></li>
			</ul>
		</dd>
	</dl>
	
	<dl id="menu-member">
			<dt><i class="Hui-iconfont">&#xe60d;</i> 后台管理员<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/travel/showAdmin" data-title="后台管理员列表" href="javascript:void(0)">后台管理员列表</a></li>
			</ul>
		</dd>
	</dl>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="欢迎页面" data-href="welcome.html">welcome</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${pageContext.request.contextPath}/travel/welcome"></iframe>
	</div>
</div>
</section>
